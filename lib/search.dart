            ...
            children: <Widget>[
              ...
              Expanded(
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal, // 縦スクロールを有効にする
                  child: SingleChildScrollView(
                    scrollDirection: Axis.vertical, // 横スクロールを有効にする
                        ...
                        return DataTable(
                          ...
                          rows: List<DataRow>.generate(
                            ...
                            (index) => DataRow(cells: [
                              ...
                              DataCell(Text(snapshot.data!.docs[index]['age']
                                  .toString())),
                              DataCell(Text(snapshot.data?.docs[index]
                              ...
                              DataCell(
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: (getUtilDateListGetter(
                                          snapshot.data?.docs[index]['process'],
                                          processItem) as List<String>)
                                      .map((language) => Text(
                                          language.toString(),
                              ...
                              DataCell(
                                Column(
                                  ...
                                  children: (getUtilDateListGetter(
                                          snapshot.data?.docs[index]
                                              ['team_role_years'],
                                          yearsCategoryItem) as List<String>)
                                      .map((language) => Text(
                                          language.toString(),
                                          style: const TextStyle(
                                              fontSize:
                              ...
                              DataCell(
                                Column(
                                  ...
                                  children: (getUtilDateListGetter(
                                          snapshot.data?.docs[index]
                                              ['code_languages'],
                                          codeLanguagesItem) as List<String>)
                                      .map((language) => Text(
                                          language.toString(),
                                          style: const TextStyle(
                                              fontSize: constData
                              ...
                              DataCell(
                                Column(
                                  ...
                                  children: (getUtilDateListGetter(
                                          snapshot.data?.docs[index]
                                              ['db_experience'],
                                          dbExperienceItem) as List<String>)
                                      .map((language) => Text(
                                          language.toString(),
                                          style: const TextStyle(
                                              fontSize:
                              ...
                              DataCell(
                                Column(
                                  ...
                                  children: (getUtilDateListGetter(
                                          snapshot.data?.docs[index]
                                              ['os_experience'],
                                          osExperienceItem) as List<String>)
                                      .map((language) => Text(
                                          language.toString(),
                                          style: const TextStyle(
                                              fontSize:
                              ...
                              DataCell(
                                Column(
                                  ...
                                  children: (getUtilDateListGetter(
                                          snapshot.data?.docs[index]
                                              ['cloud_technology'],
                                          cloudTechnologyItem) as List<String>)
                                      .map((language) => Text(
                                          language.toString(),
                                          style: const TextStyle(
                                              fontSize:
  ...
  */
  Stream<QuerySnapshot> getStream() {
    ...
    if (codeLanguagesDropdownSelectedValue.isNotEmpty) {
      query = query.where("code_languages",
          isEqualTo: codeLanguagesDropdownSelectedValue);
    }
  ...
  */
  List<String>? getUtilDateListGetter(
    ...
    for (var item in numberList) {
      if (item is int && item >= 0 && item < utilDataArray.length) {
        utilDataListForReturn.add(utilDataArray[item]);
      } else {
        logger.w("インデックスが範囲外です: $item");
      }
