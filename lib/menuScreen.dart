...
class _MenuScreenState extends ConsumerState<MenuScreen> {
  ...
  final List<Map<String, dynamic>> menuItems = [
    ...
    // 技術者登録は「編集権限(editor)」フラグを持つユーザーが対象
    ...
    {'icon': Icons.person_add_alt_1, 'activeIcon': Icons.person_add_alt_1, 'title': '自社スタッフ招待', 'roleRequired': constData.roleAdmin},
    ...
    // --- アカウントロール：保守担当(owner)限定 ---
    {'icon': Icons.business_outlined, 'activeIcon': Icons.business, 'title': '企業初回登録案内', 'roleRequired': constData.roleOwner},
  ];
                  ...
                  child: NavigationDrawer(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.hub_rounded, color: constData.themeGreen, size: 32),
                      ...
                      Padding(
                        ...
                        child: ListTile(
                          ...
                          title: Text(appUser?.displayName ?? user?.displayName ?? 'ユーザー名なし',
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          ...
          children: [
            Row(
              children: [
                UIUtils.buildStatCard(label: '技術者数', value: totalCount.toString(), unit: '名', icon: Icons.people_outline, color: constData.themeGreen),
          ...
          bottomTitles: AxisTitles(sideTitles: SideTitles(
            ...
            getTitlesWidget: (v, meta) {
              ...
              if (idx >= 0 && idx < lastSixMonths.length) {
                return SideTitleWidget(meta: meta, child: Text('${lastSixMonths[idx]}月', style: const TextStyle(fontSize: 10)));
              }
